...
function DashboardAdmin() {
  ...
  const fetchTotalProducts = async () => {
    try {
      const response = await fetch('https://vjay-chuang.vercel.app/products/total');
  ...
  const fetchTodayProfit = async () => {
    try {
      const response = await fetch('https://vjay-chuang.vercel.app/orders/profit');
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  const fetchCODProfit = async () => {
    try {
      const response = await fetch('https://vjay-chuang.vercel.app/orders/profit/COD');
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  const fetchCanceledOrders = async () => {
    try {
      const response = await fetch('https://vjay-chuang.vercel.app/orders/canceled');
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  const fetchCompletedOrders = async () => {
    try {
      const response = await fetch('https://vjay-chuang.vercel.app/orders/completed');
      const data = await response.json();
      return data;
    } catch (error) {
